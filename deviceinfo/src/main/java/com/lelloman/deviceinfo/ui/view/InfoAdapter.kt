...
) : BaseMultiTypeRecyclerViewAdapter<Long, InfoItem>(
    resourceProvider = resourceProvider,
    onClickListener = onItemClickListener
) {

    @Suppress("UNCHECKED_CAST")
    override val itemsMap: Map<Any, ItemType<Long, InfoItem, BaseListItemViewModel<Long, InfoItem>, ViewDataBinding>>
        get() {
            val out = mutableMapOf<Any, ItemType<Long, InfoItem, BaseListItemViewModel<Long, InfoItem>, ViewDataBinding>>()
            out[DisplayInfoItem::class.java] = Display as ItemType<Long, InfoItem, BaseListItemViewModel<Long, InfoItem>, ViewDataBinding>
            out[NetworkInfoItem::class.java] = Network as ItemType<Long, InfoItem, BaseListItemViewModel<Long, InfoItem>, ViewDataBinding>
            out[AudioInfoItem::class.java] = Audio as ItemType<Long, InfoItem, BaseListItemViewModel<Long, InfoItem>, ViewDataBinding>
            return out
        }
}

private object Display : ItemType<Long, DisplayInfoItem, DisplayInfoItemListItemViewModel, ListItemDisplayInfoItemBinding> {
...
private object Network : ItemType<Long, NetworkInfoItem, NetworkInfoItemListItemViewModel, ListItemNetworkInfoItemBinding> {
...
private object Audio : ItemType<Long, AudioInfoItem, AudioInfoItemListItemViewModel, ListItemAudioInfoItemBinding> {
